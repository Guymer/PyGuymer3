SUBROUTINE find_min_max_dist_bearing_geodesicSpace(                             &
    n,                                                                          &
    midLon,                                                                     &
    midLat,                                                                     &
    lons,                                                                       &
    ...
    ! Import my modules ...
    USE mod_safe, ONLY: sub_find_min_max_dist_bearing_geodesicSpace
...
END SUBROUTINE find_min_max_dist_bearing_geodesicSpace
