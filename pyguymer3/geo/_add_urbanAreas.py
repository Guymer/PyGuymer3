...
# Define function ...
def _add_urbanAreas(axis, /, *, debug = False, onlyValid = False, repair = False, resolution = "10m"):
    ...
    resolution : str, optional
        the resolution of the urban areas
    ...
    facecolor = matplotlib.colors.to_rgba(matplotlib.colors.CSS4_COLORS["gold"])
    if debug:
        print(f"INFO: \"urban_areas\" is ({facecolor[0]:.6f},{facecolor[1]:.6f},{facecolor[2]:.6f},{facecolor[3]:.6f}).")
