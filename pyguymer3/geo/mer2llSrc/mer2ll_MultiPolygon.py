...
def mer2ll_MultiPolygon(
    ...
    *,
    ...
    """Transform a MultiPolygon from Mercator fractions to Longitudes/Latitudes

    This function reads in a MultiPolygon whose coordinates are fractions on the
    Mercator projection and returns a MultiPolygon whose coordinates are
    ...
    from .mer2ll_Polygon import mer2ll_Polygon
