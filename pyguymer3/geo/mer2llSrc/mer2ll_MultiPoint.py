...
def mer2ll_MultiPoint(
    ...
    *,
    ...
    This function reads in a MultiPoint whose coordinates are fractions on the
    Mercator projection and returns a MultiPoint whose coordinates are
    ...
    from .mer2ll_Point import mer2ll_Point
