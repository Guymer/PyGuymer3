...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default = 250,
           dest = "elevInt",
           help = "the interval of the elevation bands (in metres)",
           type = int,
    )
    parser.add_argument(
        "--eps",
    ...
    parser.add_argument(
        ...
        default = "10m",
           dest = "neRes",
           help = "the resolutions of the NE dataset",
           type = str,
    )
    parser.add_argument(
        "--nAng",
    ...
    for grid in [
        ...
        for ix in range(nx):
            for iy in range(ny):
                ...
                tName = f"{args.absPathToRepo}/pyguymer3/data/png/ne/{nx:d}x{ny:d}/maxElev={args.maxElev:d}m/elevInt={args.elevInt}m/res={args.neRes}/x={ix:d}/y={iy:d}.png"
