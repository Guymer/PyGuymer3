...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
           allow_abbrev = False,
            description = "Demonstrate the GLOBE and GSHHG dataset tiles.",
    ...
    dName = f'{__file__.removesuffix(".py")}/maxElev={args.maxElev:d}m/elevInt={args.elevInt}m/res={args.gshhgRes}'
