...
Additionally, if you want to run the FORTRAN-based functions in the
:mod:`pyguymer3.f90` sub-module, then you will also require the following Python
modules to be installed and available in your ``PYTHONPATH``:
